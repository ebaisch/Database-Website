<%@ Page Language="C#" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="true" CodeFile="addproduct.aspx.cs" Inherits="addproduct" %>
<asp:Content ID="Content3" ContentPlaceHolderID="contentbody" runat="server">
    ...
    <div class="addProduct">
        ...
        <br><br>
        <asp:Button ID="addProductButton" runat="server" Text="Add Product"  CssClass="loginButton" OnClick="AddProduct"/>
    </div>
</asp:Content>